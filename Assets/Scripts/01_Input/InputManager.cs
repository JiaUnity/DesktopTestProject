...
public class InputManager : MonoBehaviour
{
    ...
    public Dropdown btn_controller;
    ...
    public void SwitchToKeyMouse()
    {
        ...
        btn_controller.colors = cb;
        btn_controller.captionText.color = col_text_disabled;
    ...
    public void SwitchToController()
    {
        ...
        cb.normalColor = cb.highlightedColor = col_background_enabled;
        btn_controller.colors = cb;
        btn_controller.captionText.color = col_text_enabled;

        int value = btn_controller.value;
        if (value == 0)
